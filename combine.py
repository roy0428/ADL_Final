...
def parse_args():
    ...
    parser.add_argument(
        "--data_dir", default="data/3000.json", type=str
    )
    parser.add_argument(
        "--prediction_dir", default="data/prediction.json", type=str
    )
    parser.add_argument(
        "--output_dir", default="combine.json", type=str
    )
...
if __name__ == "__main__":
    ...
    for index in range(len(prediction_list)):
        data = {"instruction": test_list["data"][index]["instruction"],
